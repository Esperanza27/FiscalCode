public static class CadastralCodes
{
    public static IReadOnlyDictionary<string, string> PlaceToCodeMap { get; } = new Dictionary<string, string>()
    {
        { "ABANO TERME", "A001" },
        ...
        { "SICULO", "SSIO" },
        { "DI TORINO", "OGIO" },
        { "DI VALPOLICELLA", "OGIO" },
        { "SUL GARIGLIANO", "OGIO" },
        { "DI NARCO", "OLIA" },
        { "APOSTOLO DELLO IONIO", "DREA" },
        { "DEL GARIGLIANO", "DREA" },
        { "DI CONZA", "DREA" },
        { "FRIUS", "DREA" },
        { "A CUPOLO", "GELO" },
    ...
    public static IReadOnlyDictionary<string, string> ForeignCountryCodes { get; } = new Dictionary<string, string>()
{
    { "FRANCIA", "Z110" },
    { "GERMANIA", "Z112" },
    { "STATI UNITI", "Z404" },
